...
export default function PortofolioPage() {
  const portfolioItems = [
    ...
    //   ],
    //   results: {
    //     downloads: "Loyalty Point membuat pelanggan makin loyal",
    //     rating: "4.8/5 Rating di Google My Business",
    //     orders: "Jumlah Pesanan tiap bulan meningkat secara signifikan",
    //   },
    //   year: "2024",
